...
const projects: Project[] = [
  {
    ...
    description:
      'In 2023, I started working on Homework Muffin as a Senior Design Project. It is a web/mobile application that helps students organize their homework and study for exams.',
  ...
  },
  {
    ...
    description:
      'The first project since the start of the company. We were tasked with creating a website for a local fence company. We were able to create a really nice website with admin tools to help manage the website after the project was completed.',
  ...
  },
  {
    title: 'EyeOnFi',
    description:
      'EyeOnFi is a financial forecasting tool that helps everyday people make better financial decisions. By imputing your financial data, EyeOnFi will help you forecast your financial future, helping to make informed decisions about your finances.',
...
function PageStack({ images, title }: { images: string[]; title: string }) {
  ...
  return (
    <div className="relative w-[340px] md:w-[420px] md:h-[550px] mx-auto md:mx-0 overflow-visible">
      <div
        ref={img0Ref}
        onMouseEnter={() => bringToFront(img0Ref.current, img1Ref.current)}
        className="absolute top-0 left-0 w-[260px] h-[370px] md:w-[300px] md:h-[430px] rounded-lg overflow-hidden shadow-card cursor-pointer"
      ...
      <div
        ...
        className="absolute top-[80px] left-[100px] md:top-[100px] md:left-[130px] w-[260px] h-[370px] md:w-[300px] md:h-[430px] rounded-lg overflow-hidden shadow-card cursor-pointer"
