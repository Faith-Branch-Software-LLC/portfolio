...
export default function HarveyRegistry() {
  return (
    <div className="w-full bg-white h-full mt-52 md:mt-80 flex flex-col justify-center items-center relative">
      ...
      />
      <h1 className="text-4xl md:text-6xl font-bold text-center z-10 -mt-20 md:-mt-0 font-sendFlowers leading-[1.1]">Makayla & Josiah <br /> <span className="text-3xl md:text-4xl">Wedding Registries</span></h1>
      <Image src="/images/flower-sep.svg" alt="Flower Separator" width={300} height={300} className="w-3/4 md:w-1/2 my-2" />
